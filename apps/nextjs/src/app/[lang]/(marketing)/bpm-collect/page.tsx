  ...
  return (
    <>
      ...
      <div id="hero-demo-container" className="relative pt-20 z-10">
        <div
          id="ball"
          className="absolute w-5 h-5 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full z-10 shadow-lg shadow-purple-500/40"
        ></div>
        <div
          id="square"
          className="absolute w-[18px] h-[18px] bg-gradient-to-br from-orange-500 to-pink-600 z-10 shadow-lg shadow-orange-500/40"
        ></div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    transitions with precise BPM matching for professional
                    performances.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    during events and gigs without interrupting your
                    performance.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    with precise BPM data and comprehensive metadata tracking.
                  </p>
                </motion.div>
