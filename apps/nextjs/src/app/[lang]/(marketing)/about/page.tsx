    ...
    <div className="relative bg-black text-white">
      ...
      <section className="relative z-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        ...
        <div className="prose prose-lg mx-auto text-center">
          <p className="text-lg md:text-xl leading-relaxed text-gray-300 mb-6">
            Today, algorithms and automation define much of our lives. But in
            this process, meaning and human connection are often lost.
          </p>
          <p className="text-lg md:text-xl leading-relaxed text-gray-300">
            At Objktt Studio, we believe technology should amplify humanity, not
            replace it. We don't just solve problems — we peel away layers of
            complexity, returning to the essence of each subject and creating
            solutions that feel natural, human, and enduring over time.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-20 py-20 lg:py-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="prose prose-lg mx-auto">
            <p className="text-lg md:text-xl leading-relaxed text-gray-300 mb-6">
              Taste is personal. Humanity is universal. And Beyond is where new
              possibilities emerge.
            </p>
            <p className="text-lg md:text-xl leading-relaxed text-gray-300">
              We stand at the intersection of these three elements — creating
              experiences that honor individual taste, nurture human connection,
              and evolve gracefully as they move forward. From there, we venture
              beyond.
            </p>
          </div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              The philosophy of Objktt Studio comes to life through Kolektt, a
              platform designed to grow and change naturally over time.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 border border-white/20">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Catalog, share, and explore vinyl collections as they evolve and
                expand.
              </p>
              <Link
                href={`/${lang}`}
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20 border border-white/20">
              ...
              <p className="text-green-400 mb-4 font-medium text-sm uppercase tracking-wide">
                For DJs and vinyl enthusiasts
              </p>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Analyze BPM, map energy and duration, and design performances
                that connect music with experience.
              </p>
              <Link
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 border border-white/20">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Manage inventory, sales, and customer relationships with
      ...
      <section className="relative z-20 py-20 lg:py-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="prose prose-lg mx-auto">
            <p className="text-lg md:text-xl leading-relaxed text-gray-300 mb-6">
              Objktt Studio is a collective of designers, developers, and music
              lovers dedicated to solving problems by returning to their
              essence, while pacing every solution with sensitivity to context
              and growth.
            </p>
            <p className="text-lg md:text-xl leading-relaxed text-gray-300">
              We merge design, technology, and music to create products that are
              functional, soulful, and lasting. Rather than chasing fleeting
              trends or blind automation, we focus on what makes us human —
              taste, emotion, and connection — allowing these qualities to
              deepen and evolve over time.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="w-[90%] mx-auto">
          <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 lg:p-12 border border-white/10 text-center">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed max-w-4xl mx-auto">
              ...
              creating meaningful products that bridge music, technology, and
              humanity.
            </p>
