        ...
        <div className="top-header position-relative">
          <div className="d-flex align-items-center justify-content-between">
            <div className="logo order-lg-0 me-lg-5">
              <Link href={`/${lang}`} className="d-flex align-items-center" style={{textDecoration: 'none', outline: 'none'}}>
                <span style={{fontWeight: 800, fontSize: '22px', letterSpacing: '0.5px', color: '#000'}}>Kolektt</span>
              </Link>
            </div>
            
            <div className="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
              <Link href={`/${lang}/hub`} className="btn-global-header" data-event="enter_hub_click">Enter Hub</Link>
            </div>
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav align-items-lg-center">
                  <li className="d-block d-lg-none">
                    <div className="logo">
                      <Link href={`/${lang}`} className="d-block" style={{textDecoration: 'none', outline: 'none'}}>
                        <span style={{fontWeight: 800, fontSize: '22px', letterSpacing: '0.5px', color: '#000'}}>Kolektt</span>
                      </Link>
                    </div>
                  </li>
