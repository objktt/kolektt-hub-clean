            ...
            <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-base md:text-lg text-center text-gray-300 mt-6">
                        Start for free and upgrade when you're ready to unlock the full power of vinyl collecting and trading.
                    </p>
                </div>
                <div className="flex items-center justify-center space-x-4 mt-8">
                    <span className={cn("text-base font-medium", billPlan === "monthly" ? "text-white" : "text-gray-400")}>Monthly</span>
                    ...
                    <span className={cn("text-base font-medium", billPlan === "annually" ? "text-white" : "text-gray-400")}>
                        Annually
                        {billPlan === "annually" && <span className="ml-2 text-sm text-green-400">(Save 17%)</span>}
                    </span>
                </div>
            </div>
